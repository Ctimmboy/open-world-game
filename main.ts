...
sprites.onOverlap(SpriteKind.Player, SpriteKind.alter, function (sprite, otherSprite) {
    for (let index = 0; index < 4; index++) {
        myEnemy = sprites.create(img`
            ...
            ....f.....f.....
            `, SpriteKind.Enemy)
        myEnemy.follow(mySprite, randint(60, 90))
        tiles.placeOnRandomTile(myEnemy, assets.tile`myTile`)
        myEnemy.setFlag(SpriteFlag.GhostThroughSprites, false)
...
for (let value2 of tiles.getTilesByType(sprites.castle.saplingPine)) {
    tree2 = sprites.create(img`
        ...
        ...............f................
        `, SpriteKind.tree)
    tiles.placeOnTile(tree2, value2)
    tiles.setTileAt(value2, sprites.castle.tileGrass1)
}
tiles.replaceAllTiles(sprites.castle.rock1, sprites.castle.rock0)
for (let value3 of tiles.getTilesByType(sprites.castle.rock0)) {
...
for (let value4 of tiles.getTilesByType(assets.tile`myTile`)) {
    alter = sprites.create(img`
        ...
        8888888888888888
        `, SpriteKind.alter)
    tiles.placeOnTile(alter, value4)
}
statusbar = statusbars.create(20, 4, StatusBarKind.Health)
statusbar.destroy()
...
tiles.placeOnRandomTile(mySprite2, tiles.util.object1)
tiles.replaceAllTiles(tiles.util.object1, assets.tile`transparency16`)
damage = -7
let mySprite3 = sprites.create(img`
    ...
    ................................................
    `, SpriteKind.door)
tiles.placeOnTile(mySprite3, tiles.getTileLocation(251, 171))
statusbar.value = 100
...
forever(function () {
    if (mySprite.x == 114 && mySprite.y == 124) {
        mySprite.destroy()
    }
})
forever(function () {
